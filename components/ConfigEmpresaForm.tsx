...
const inputClass = 'w-full rounded-xl border border-white/10 bg-slate-950/70 px-3 py-2 text-sm text-white outline-none ring-0 transition placeholder:text-slate-500 focus:border-[#c81f2a]'
    ...
    <form onSubmit={onSubmit} className="space-y-6">
      <section className="rounded-2xl border border-white/10 bg-slate-900/70 p-5 shadow-xl">
        <div className="mb-5 flex items-center justify-between gap-4">
          ...
          <button type="submit" disabled={saving} className="rounded-xl bg-[#c81f2a] px-4 py-2 text-sm font-semibold text-[#0a0d12] transition hover:bg-[#ff5468] disabled:opacity-50">
