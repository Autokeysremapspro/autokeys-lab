      ...
      <div className="relative mx-auto grid min-h-screen max-w-[1600px] lg:grid-cols-[.78fr_1.22fr]">
        <aside className="relative hidden overflow-hidden border-r border-white/10 lg:block">
          ...
          <div className="relative flex h-full flex-col justify-between p-10 xl:p-14">
            ...
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-[#e2954d]/30 bg-[#e2954d]/10 px-4 py-2 text-xs font-bold uppercase tracking-[.24em] text-[#ffb870]"><Sparkles size={15}/> Acceso profesional</span>
              <h1 className="mt-6 text-5xl font-bold uppercase italic leading-[.95] xl:text-7xl">Únete a la red de <span className="text-[#e2954d]">Autokeys.</span></h1>
            ...
            <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
              {['Cuenta verificada', 'Precios profesionales', 'Soporte técnico'].map((item) => <div key={item} className="rounded-2xl border border-white/10 bg-black/45 p-4 text-sm font-bold backdrop-blur-xl"><CheckCircle2 className="mb-3 text-[#ffb870]" size={20}/>{item}</div>)}
            </div>
          </div>
        </aside>
        ...
        <section className="relative flex items-center justify-center px-5 py-8 md:px-10 xl:px-16">
          <div className="w-full max-w-4xl rounded-[2rem] border border-white/12 bg-[#090b0f]/92 p-6 shadow-[0_50px_140px_rgba(0,0,0,.72)] backdrop-blur-2xl md:p-9">
            <div className="flex flex-col justify-between gap-5 border-b border-white/10 pb-6 sm:flex-row sm:items-center">
              <div>
                <p className="text-xs font-bold uppercase tracking-[.25em] text-[#ffb870]">Solicitud de distribuidor</p>
            ...
            <div className="mt-7 flex items-center justify-between gap-3 border-t border-white/10 pt-6">
              ...
              {step<4?<button onClick={next} className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-[#8a4a1f] to-[#e2954d] px-6 py-3 text-sm font-bold uppercase shadow-[0_16px_45px_rgba(217,4,41,.3)]">Continuar <ChevronRight size={18}/></button>:<button onClick={submit} disabled={loading} className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-[#8a4a1f] to-[#e2954d] px-7 py-3 text-sm font-bold uppercase disabled:opacity-60">{loading?'Enviando...':'Enviar solicitud'} <ArrowRight size={18}/></button>}
            </div>
            <p className="mt-5 text-center text-sm text-white/35">¿Ya tienes acceso? <Link href="/login" className="font-bold text-[#ffb870]">Iniciar sesión</Link></p>
          </div>
        </section>
      </div>
    </main>
