...
export default function AkCloudPedidoPage() {
  ...
  const currentIndex = Math.max(0, timeline.findIndex((item) => item.key === (pedido.estado || 'pendiente')))
            ...
            <section className="rounded-[2rem] border border-white/10 bg-[#0B1220] p-6">
              ...
              {pedido.observaciones && (
                <div className="mt-4 rounded-2xl border border-white/5 bg-black/20 p-4">
                  ...
                  <p className="mt-2 text-zinc-300 whitespace-pre-wrap">{pedido.observaciones}</p>
                </div>
              )}
            </section>
          </main>
          ...
          <aside className="space-y-6">
            <section className="rounded-[2rem] border border-white/10 bg-[#0B1220] p-6">
              ...
              <div className="mt-5 space-y-4">
                ...
                <button onClick={saveAdmin} disabled={working === 'save'} className="btn btn-red w-full inline-flex items-center justify-center gap-2 disabled:opacity-50">
            ...
            <section className="rounded-[2rem] border border-white/10 bg-[#0B1220] p-6">
              ...
              <p className="mt-1 text-sm text-zinc-500">Descarga ORI o MOD desde el bucket compartido.</p>
              <div className="mt-5 grid gap-3">
                ...
                <button onClick={() => downloadFile('mod')} className="btn btn-dark inline-flex items-center justify-center gap-2">
                  <UploadCloud size={17} /> Descargar MOD
                </button>
              </div>
            </section>
            ...
            <section className="rounded-[2rem] border border-emerald-500/20 bg-emerald-500/10 p-6">
              ...
              <p className="mt-2 text-sm text-zinc-400">Al convertirlo, se crea cliente, vehículo y expediente técnico en Autokeys Core.</p>
            </section>
          </aside>
        </div>
      </div>
