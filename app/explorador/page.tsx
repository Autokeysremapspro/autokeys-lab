      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
          <div className="xl:col-span-3 card p-4 min-h-[520px]">
            <div className="flex items-center gap-2 mb-4 font-bold"><User size={18} /> Clientes</div>
          ...
          <div className="xl:col-span-3 card p-4 min-h-[520px]">
            <div className="flex items-center gap-2 mb-4 font-bold"><Car size={18} /> Vehículos</div>
          ...
          <div className="xl:col-span-6 space-y-6">
            <div className="card p-5">
              <div className="text-xs text-zinc-500 font-bold uppercase tracking-[0.18em]">Selección actual</div>
            ...
            <div className="card p-5">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2 font-bold"><ClipboardList size={18} /> Expedientes</div>
            ...
            <div className="card p-5">
              <div className="flex items-center gap-2 font-bold mb-4"><FileText size={18} /> Documentos del cliente</div>
